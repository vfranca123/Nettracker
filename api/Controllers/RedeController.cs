...
namespace Api.controller
{
    ...
    public class RedeController : ControllerBase // define que a rede controller extendera o controller base 
    {
        ...
        public IActionResult PostRede([FromBodyAttribute] Rede rede) { // uma função do tipo  "IActionResult" que recebera os atributos do corpo e tentara colocaro em um objeto com nome "rede" da classe Rede que esta em models 
